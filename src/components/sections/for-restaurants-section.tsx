...
const RESTAURANT_FEATURES = [
  {
    ...
    desc: "Reduce crowd & chaos at your entrance",
  ...
  },
  {
    ...
    desc: "Get orders in advance. Kitchen prep ready",
  ...
  },
  {
    ...
    desc: "Monitor live queue, tables & revenue",
  ...
  },
  {
    ...
    desc: "Serve 35% more diners every night",
  ...
  },
  {
    ...
    desc: "Serve timely. Eliminate walkouts",
  ...
  },
  {
    icon: Zap,
    title: "Easy Setup",
    desc: "Go live in 20 mins. Zero hardware",
    ...
    <section id="for-restaurants" className="py-20 sm:py-28 bg-[#F8FAFF] text-stone-900 border-b border-stone-200 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
              {RESTAURANT_FEATURES.map((f) => {
                ...
                return (
                  <div
                    key={f.title}
                    className="flex items-start gap-3 p-3 rounded-2xl bg-white border border-stone-200 shadow-xs hover:shadow-md hover:border-indigo-300 transition-all duration-300 group"
                  >
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-stone-500 mt-0.5">{f.desc}</p>
                    </div>
                  </div>
                );
              })}
          ...
          <div className="lg:col-span-7 bg-[#070E20] rounded-3xl p-5 sm:p-6 text-white border border-white/15 shadow-2xl overflow-hidden gold-border-glow">
            {/* Top Bar */}
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 my-4">
              <div className="p-2.5 rounded-xl bg-white/[0.05] border border-white/10 text-center">
                ...
                <p className="text-lg font-black text-white">34 Guests</p>
              </div>
              <div className="p-2.5 rounded-xl bg-white/[0.05] border border-white/10 text-center">
                <p className="text-[10px] text-slate-400">Avg Wait Time</p>
                <p className="text-lg font-black text-amber-300">28 min</p>
              </div>
              <div className="p-2.5 rounded-xl bg-white/[0.05] border border-white/10 text-center">
                <p className="text-[10px] text-slate-400">Tables Occupied</p>
                <p className="text-lg font-black text-teal-300">{tablesOccupied} / 18</p>
              </div>
              <div className="p-2.5 rounded-xl bg-white/[0.05] border border-white/10 text-center">
