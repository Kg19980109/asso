        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-7 items-stretch">
          ...
          <div className="lg:col-span-5">
            <ScrollReveal direction="left" delay={100} className="h-full">
              <div className="relative rounded-3xl overflow-hidden border border-stone-200 shadow-2xl min-h-[400px] h-full bg-stone-900 group">
                <Image
                ...
                <div className="absolute inset-x-6 top-1/2 -translate-y-1/2 p-3.5 rounded-2xl bg-black/80 backdrop-blur-md border border-white/20 text-white text-xs space-y-1">
                  <p className="font-bold text-rose-300 flex items-center gap-1">
                    <span>❌ The Traditional Queue:</span>
                  </p>
                  <p className="text-[11px] text-slate-300 leading-relaxed">
                    Stuck on the road for 1+ hour. Feet hurt, phones run out of battery, kids get cranky. Missed the Sreebhumi illumination light show.
                  </p>
                </div>
                ...
                <div className="absolute bottom-6 left-6 right-6 flex items-center justify-between">
                  ...
                  <span className="text-xs text-rose-400 font-mono font-bold">Avg queue: 75 min</span>
                </div>
              </div>
            </ScrollReveal>
          </div>
          ...
          <div className="lg:col-span-7">
            <ScrollReveal direction="right" delay={150} className="h-full">
              <div className="bg-[#0A1024] rounded-3xl p-6 sm:p-8 border border-white/15 text-white shadow-2xl flex flex-col justify-between gold-border-glow relative overflow-hidden h-full">
                ...
                <div>
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-6">
                    ...
                    <span className="text-xs px-3 py-1 rounded-full bg-emerald-500/20 text-emerald-300 border border-emerald-500/30 font-bold self-start sm:self-auto flex items-center gap-1">
                      <Sparkles className="w-3 h-3 text-emerald-400" />
                      <span>{TIMELINE_STEPS[activeStep].saved} Saved</span>
                    </span>
                  </div>
                    ...
                    {TIMELINE_STEPS.map((step, i) => {
                      ...
                      return (
                        <div
                          ...
                          className={`flex flex-col items-center text-center p-2.5 rounded-2xl cursor-pointer transition-all duration-200 ${
                            isSelected
                              ? "bg-white/20 border border-amber-400/80 shadow-lg scale-105"
                        ...
                        >
                          ...
                          <div
                            className={`w-10 h-10 rounded-full ${step.color} border-2 ${
                              isSelected ? "border-amber-300 scale-110 shadow-amber-400/50" : "border-white/20"
                  ...
                  <div className="mt-6 p-4 rounded-2xl bg-white/[0.08] border border-white/15 flex items-center justify-between text-xs backdrop-blur-sm">
                    ...
                    {onOpenQueue && (
                      <button
                        onClick={onOpenQueue}
                        className="px-4 py-2 rounded-xl bg-purple-600 hover:bg-purple-500 text-white font-bold text-xs flex items-center gap-1 shadow-md transition-all active:scale-95 flex-shrink-0 cursor-pointer"
                      >
                        <span>Try ASSO</span>
                ...
                <div className="mt-6 pt-4 border-t border-white/10 flex items-center justify-between text-xs text-slate-400">
                  <span className="font-semibold text-emerald-400 flex items-center gap-1.5">
                    ...
                    Zero waiting at the restaurant entrance
                  </span>
