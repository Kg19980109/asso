      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-7">
          ...
          {/* =========================================================================
             ...
             ========================================================================= */}
          <div className="flex flex-col bg-white/[0.04] hover:bg-white/[0.08] rounded-[28px] p-4 sm:p-5 border border-white/10 hover:border-rose-400/50 backdrop-blur-md shadow-2xl transition-all duration-300 group">
            {/* Step Header */}
            ...
            <div className="mt-4 relative rounded-[26px] border-[3px] border-slate-700 bg-slate-950 p-1.5 shadow-2xl overflow-hidden group-hover:border-slate-500 transition-colors">
              ...
              {/* Screen Canvas */}
              <div className="bg-[#0D152E] rounded-[20px] p-3 pt-5 text-white flex flex-col justify-between min-h-[300px] border border-white/10">
          ...
          {/* =========================================================================
              STEP 2: Scan QR & Join
             ========================================================================= */}
          <div className="flex flex-col bg-white/[0.04] hover:bg-white/[0.08] rounded-[28px] p-4 sm:p-5 border border-white/10 hover:border-blue-400/50 backdrop-blur-md shadow-2xl transition-all duration-300 group">
            {/* Step Header */}
            <div className="flex items-start gap-3 mb-2">
              ...
              <div className="bg-[#0D152E] rounded-[20px] p-3 pt-5 text-white flex flex-col justify-between min-h-[300px] border border-white/10">
                ...
                <div className="flex flex-col items-center text-center py-2">
                  ...
                  <div className="w-28 h-28 bg-white rounded-2xl flex flex-col items-center justify-center p-2 my-2 shadow-lg relative overflow-hidden border-2 border-blue-400">
                    ...
                    <div className="absolute inset-x-2 top-1/2 h-0.5 bg-blue-600 animate-pulse shadow-[0_0_10px_rgba(37,99,235,1)]" />
                  </div>
          ...
          {/* =========================================================================
             ...
             ========================================================================= */}
          <div className="flex flex-col bg-white/[0.04] hover:bg-white/[0.08] rounded-[28px] p-4 sm:p-5 border border-white/10 hover:border-teal-400/50 backdrop-blur-md shadow-2xl transition-all duration-300 group">
            {/* Step Header */}
            <div className="flex items-start gap-3 mb-2">
            ...
            <div className="mt-4 relative rounded-[26px] border-[3px] border-slate-700 bg-slate-950 p-1.5 shadow-2xl overflow-hidden group-hover:border-slate-500 transition-colors">
              ...
              {/* Screen Canvas */}
              <div className="bg-gradient-to-b from-[#0B2528] to-[#08181D] rounded-[20px] p-3 pt-5 text-white flex flex-col justify-between min-h-[300px] border border-teal-500/30">
          ...
          {/* =========================================================================
             ...
             ========================================================================= */}
          <div className="flex flex-col bg-white/[0.04] hover:bg-white/[0.08] rounded-[28px] p-4 sm:p-5 border border-white/10 hover:border-orange-400/50 backdrop-blur-md shadow-2xl transition-all duration-300 group">
            {/* Step Header */}
            <div className="flex items-start gap-3 mb-2">
            ...
            <div className="mt-4 relative rounded-[26px] border-[3px] border-slate-700 bg-slate-950 p-1.5 shadow-2xl overflow-hidden group-hover:border-slate-500 transition-colors">
              ...
              {/* Screen Canvas */}
              <div className="bg-gradient-to-b from-[#2A1408] to-[#170C05] rounded-[20px] p-3 pt-5 text-white flex flex-col justify-between min-h-[300px] border border-orange-500/30">
          ...
          <div className="flex flex-col bg-white/[0.04] hover:bg-white/[0.08] rounded-[28px] p-4 sm:p-5 border border-white/10 hover:border-blue-400/50 backdrop-blur-md shadow-2xl transition-all duration-300 group">
            ...
            <div className="mt-4 relative rounded-[26px] border-[3px] border-slate-700 bg-slate-950 p-1.5 shadow-2xl overflow-hidden group-hover:border-slate-500 transition-colors">
              ...
              {/* Screen Canvas */}
              <div className="bg-[#0B1530] rounded-[20px] p-3 pt-5 text-white flex flex-col justify-between min-h-[300px] border border-blue-500/30">
          ...
          {/* =========================================================================
             ...
             ========================================================================= */}
          <div className="flex flex-col bg-white/[0.04] hover:bg-white/[0.08] rounded-[28px] p-4 sm:p-5 border border-white/10 hover:border-purple-400/50 backdrop-blur-md shadow-2xl transition-all duration-300 group">
            {/* Step Header */}
            <div className="flex items-start gap-3 mb-2">
            ...
            <div className="mt-4 relative rounded-[26px] border-[3px] border-slate-700 bg-slate-950 p-1.5 shadow-2xl overflow-hidden group-hover:border-slate-500 transition-colors">
              ...
              <div className="relative rounded-[20px] overflow-hidden min-h-[300px] flex flex-col justify-between p-3 pt-5 text-white border border-white/10">
                <Image
          ...
          {/* =========================================================================
             ...
             ========================================================================= */}
          <div className="flex flex-col bg-white/[0.04] hover:bg-white/[0.08] rounded-[28px] p-4 sm:p-5 border border-white/10 hover:border-indigo-400/50 backdrop-blur-md shadow-2xl transition-all duration-300 group">
            {/* Step Header */}
            <div className="flex items-start gap-3 mb-2">
            ...
            <div className="mt-4 relative rounded-[26px] border-[3px] border-slate-700 bg-slate-950 p-1.5 shadow-2xl overflow-hidden group-hover:border-slate-500 transition-colors">
              ...
              <div className="bg-gradient-to-b from-[#1E1B4B] to-[#0F0E2A] rounded-[20px] p-3 pt-5 text-white flex flex-col justify-between min-h-[300px] border border-indigo-500/30">
                {/* Lockscreen clock */}
          ...
          {/* =========================================================================
             ...
             ========================================================================= */}
          <div className="flex flex-col bg-white/[0.04] hover:bg-white/[0.08] rounded-[28px] p-4 sm:p-5 border border-white/10 hover:border-emerald-400/50 backdrop-blur-md shadow-2xl transition-all duration-300 group">
            {/* Step Header */}
            <div className="flex items-start gap-3 mb-2">
